...
var app = (function () {
    ...
    const file$h = "src\\Componets\\Button\\Button.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$h, 3, 32, 83);
    			attr_dev(button, "class", "interest_button svelte-2dds3x");
    			add_location(button, file$h, 3, 0, 51);
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$h, create_fragment$h, safe_not_equal, { interest_button: 0 });
    ...
    const file$g = "src\\Componets\\Info-Box\\Carousel-Info-Box.svelte";
    ...
    const file$f = "src\\Componets\\Carousel\\Carousel.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$f, 29, 19, 937);
    			attr_dev(h10, "class", "svelte-e7zi3g");
    			add_location(h10, file$f, 33, 20, 1096);
    			attr_dev(p0, "class", "svelte-e7zi3g");
    			add_location(p0, file$f, 34, 20, 1136);
    			attr_dev(div0, "class", "info svelte-e7zi3g");
    			add_location(div0, file$f, 32, 16, 1057);
    			attr_dev(div1, "id", "bottom-nav");
    			attr_dev(div1, "class", "svelte-e7zi3g");
    			add_location(div1, file$f, 31, 12, 1019);
    			attr_dev(div2, "class", "A svelte-e7zi3g");
    			add_location(div2, file$f, 30, 8, 991);
    			attr_dev(div3, "class", "x svelte-e7zi3g");
    			add_location(div3, file$f, 29, 4, 922);
    			...
    			add_location(img1, file$f, 40, 9, 1261);
    			attr_dev(h11, "class", "svelte-e7zi3g");
    			add_location(h11, file$f, 44, 20, 1420);
    			attr_dev(p1, "class", "svelte-e7zi3g");
    			add_location(p1, file$f, 45, 20, 1460);
    			attr_dev(div4, "class", "info svelte-e7zi3g");
    			add_location(div4, file$f, 43, 16, 1381);
    			attr_dev(div5, "id", "bottom-nav");
    			attr_dev(div5, "class", "svelte-e7zi3g");
    			add_location(div5, file$f, 42, 12, 1343);
    			attr_dev(div6, "class", "A svelte-e7zi3g");
    			add_location(div6, file$f, 41, 8, 1315);
    			attr_dev(div7, "class", "svelte-e7zi3g");
    			add_location(div7, file$f, 40, 4, 1256);
    			...
    			add_location(img2, file$f, 51, 9, 1585);
    			attr_dev(h12, "class", "svelte-e7zi3g");
    			add_location(h12, file$f, 54, 16, 1723);
    			attr_dev(p2, "class", "svelte-e7zi3g");
    			add_location(p2, file$f, 55, 20, 1763);
    			attr_dev(div8, "class", "info svelte-e7zi3g");
    			add_location(div8, file$f, 53, 12, 1688);
    			attr_dev(div9, "id", "bottom-nav");
    			attr_dev(div9, "class", "svelte-e7zi3g");
    			add_location(div9, file$f, 52, 23, 1654);
    			attr_dev(div10, "class", "A svelte-e7zi3g");
    			add_location(div10, file$f, 52, 8, 1639);
    			attr_dev(div11, "class", "svelte-e7zi3g");
    			add_location(div11, file$f, 51, 4, 1580);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$f, 64, 4, 1994);
    			attr_dev(div1, "id", "Box");
    			attr_dev(div1, "class", "svelte-e7zi3g");
    			add_location(div1, file$f, 17, 0, 548);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$e = "src\\Componets\\Navigation\\Navigation.svelte";
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-1v3yi66");
    			add_location(a0, file$e, 17, 23, 524);
    			attr_dev(div0, "class", "links svelte-1v3yi66");
    			add_location(div0, file$e, 17, 4, 505);
    			attr_dev(a1, "href", "/register/");
    			attr_dev(a1, "class", "svelte-1v3yi66");
    			add_location(a1, file$e, 18, 23, 607);
    			attr_dev(div1, "class", "links svelte-1v3yi66");
    			add_location(div1, file$e, 18, 4, 588);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = space();
    			img = element("img");
    			attr_dev(script, "class", "svelte-1v3yi66");
    			add_location(script, file$e, 22, 0, 728);
    			attr_dev(a0, "class", "dropdown_item svelte-1v3yi66");
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-1v3yi66");
    			add_location(a0, file$e, 13, 23, 288);
    			attr_dev(div0, "class", "links svelte-1v3yi66");
    			add_location(div0, file$e, 13, 4, 269);
    			attr_dev(a1, "href", "None");
    			attr_dev(a1, "class", "svelte-1v3yi66");
    			add_location(a1, file$e, 14, 23, 345);
    			attr_dev(div1, "class", "links svelte-1v3yi66");
    			add_location(div1, file$e, 14, 4, 326);
    			attr_dev(a2, "href", "/home/");
    			attr_dev(a2, "class", "svelte-1v3yi66");
    			add_location(a2, file$e, 15, 23, 399);
    			attr_dev(div2, "class", "links svelte-1v3yi66");
    			add_location(div2, file$e, 15, 4, 380);
    			attr_dev(div3, "class", "Nav svelte-1v3yi66");
    			set_style(div3, "margin-top", "1vmax");
    			add_location(div3, file$e, 12, 0, 221);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src\\Componets\\Search-Bar\\SearchBar.svelte";
    ...
    const file$c = "src\\Componets\\Suggest\\Suggest.svelte";
    ...
    const file$b = "src\\Componets\\UpComming\\UpComming.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			img2 = element("img");
    			add_location(h10, file$b, 28, 26, 914);
    			add_location(p0, file$b, 28, 35, 923);
    			attr_dev(div0, "class", "text svelte-8973ip");
    			add_location(div0, file$b, 28, 8, 896);
    			attr_dev(img0, "class", "suggest-img svelte-8973ip");
    			if (!src_url_equal(img0.src, img0_src_value = "")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$b, 29, 8, 945);
    			attr_dev(div1, "class", "suggest svelte-8973ip");
    			add_location(div1, file$b, 27, 4, 866);
    			attr_dev(a0, "class", "carouselfsuggestlink");
    			attr_dev(a0, "href", "/None/");
    			add_location(a0, file$b, 26, 8, 815);
    			add_location(h11, file$b, 35, 26, 1109);
    			add_location(p1, file$b, 35, 35, 1118);
    			attr_dev(div2, "class", "text svelte-8973ip");
    			add_location(div2, file$b, 35, 8, 1091);
    			attr_dev(img1, "class", "suggest-img svelte-8973ip");
    			if (!src_url_equal(img1.src, img1_src_value = "")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$b, 36, 8, 1140);
    			attr_dev(div3, "class", "suggest svelte-8973ip");
    			add_location(div3, file$b, 34, 4, 1061);
    			attr_dev(a1, "class", "carouselfsuggestlink");
    			attr_dev(a1, "href", "/None/");
    			add_location(a1, file$b, 33, 0, 1010);
    			add_location(h12, file$b, 41, 26, 1295);
    			add_location(p2, file$b, 41, 35, 1304);
    			attr_dev(div4, "class", "text svelte-8973ip");
    			add_location(div4, file$b, 41, 8, 1277);
    			attr_dev(img2, "class", "suggest-img svelte-8973ip");
    			if (!src_url_equal(img2.src, img2_src_value = "")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$b, 42, 8, 1326);
    			attr_dev(div5, "class", "suggest svelte-8973ip");
    			add_location(div5, file$b, 40, 4, 1247);
    			attr_dev(a2, "class", "carouselfsuggestlink");
    			attr_dev(a2, "href", "/None/");
    			add_location(a2, file$b, 39, 0, 1196);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_prev_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$b, 24, 8, 747);
    			attr_dev(div, "slot", "prev");
    			attr_dev(div, "class", "custom-arrow custom-arrow-prev");
    			add_location(div, file$b, 23, 4, 658);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_next_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$b, 47, 8, 1484);
    			attr_dev(div, "slot", "next");
    			attr_dev(div, "class", "custom-arrow custom-arrow-next");
    			add_location(div, file$b, 46, 4, 1395);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 17, 0, 462);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src\\Componets\\Footer\\Footer.svelte";
    ...
    const file$9 = "Join-Club\\Join-Club.svelte";
    ...
    class Join_Club extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { join: 0 });
    ...
    const file$8 = "src\\Componets\\Club_page\\club_page.svelte";
    ...
    const file$7 = "src\\Componets\\LoadingDots\\LoadingDot.svelte";
    ...
    const file$6 = "src\\Componets\\Results\\Results.svelte";
    ...
    // (15:0) {#if window.location.href.includes("home")}
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(15:0) {#if window.location.href.includes(\\\"home\\\")}",
    		ctx
    	});
    ...
    // (25:0) {#if window.location.href.includes("club")}
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(25:0) {#if window.location.href.includes(\\\"club\\\")}",
    		ctx
    	});
