...
var app = (function () {
    ...
    const file$d = "src\\Componets\\Button\\Button.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$d, 3, 32, 86);
    			attr_dev(button, "class", "interest_button svelte-2dds3x");
    			add_location(button, file$d, 3, 0, 54);
    		},
    ...
    const file$c = "src\\Componets\\Info-Box\\Carousel-Info-Box.svelte";
    ...
    const file$b = "src\\Componets\\Carousel\\Carousel.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$b, 29, 19, 966);
    			attr_dev(h10, "class", "svelte-21b3a");
    			add_location(h10, file$b, 33, 20, 1181);
    			attr_dev(p0, "class", "svelte-21b3a");
    			add_location(p0, file$b, 34, 20, 1221);
    			attr_dev(div0, "id", "info");
    			attr_dev(div0, "class", "svelte-21b3a");
    			add_location(div0, file$b, 32, 16, 1144);
    			attr_dev(div1, "id", "bottom-nav");
    			attr_dev(div1, "class", "svelte-21b3a");
    			add_location(div1, file$b, 31, 12, 1105);
    			attr_dev(div2, "class", "A svelte-21b3a");
    			add_location(div2, file$b, 30, 8, 1076);
    			attr_dev(div3, "class", "x svelte-21b3a");
    			add_location(div3, file$b, 29, 4, 951);
    			...
    			add_location(img1, file$b, 40, 9, 1365);
    			attr_dev(h11, "class", "svelte-21b3a");
    			add_location(h11, file$b, 44, 20, 1580);
    			attr_dev(p1, "class", "svelte-21b3a");
    			add_location(p1, file$b, 45, 20, 1620);
    			attr_dev(div4, "id", "info");
    			attr_dev(div4, "class", "svelte-21b3a");
    			add_location(div4, file$b, 43, 16, 1543);
    			attr_dev(div5, "id", "bottom-nav");
    			attr_dev(div5, "class", "svelte-21b3a");
    			add_location(div5, file$b, 42, 12, 1504);
    			attr_dev(div6, "class", "A svelte-21b3a");
    			add_location(div6, file$b, 41, 8, 1475);
    			attr_dev(div7, "class", "svelte-21b3a");
    			add_location(div7, file$b, 40, 4, 1360);
    			...
    			add_location(img2, file$b, 51, 9, 1764);
    			attr_dev(h12, "class", "svelte-21b3a");
    			add_location(h12, file$b, 53, 27, 1939);
    			attr_dev(p2, "class", "svelte-21b3a");
    			add_location(p2, file$b, 53, 45, 1957);
    			attr_dev(div8, "id", "info");
    			attr_dev(div8, "class", "svelte-21b3a");
    			add_location(div8, file$b, 53, 12, 1924);
    			attr_dev(div9, "id", "bottom-nav");
    			attr_dev(div9, "class", "svelte-21b3a");
    			add_location(div9, file$b, 52, 23, 1889);
    			attr_dev(div10, "class", "A svelte-21b3a");
    			add_location(div10, file$b, 52, 8, 1874);
    			attr_dev(div11, "class", "svelte-21b3a");
    			add_location(div11, file$b, 51, 4, 1759);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "svelte-21b3a");
    			add_location(div0, file$b, 61, 4, 2196);
    			attr_dev(div1, "id", "Box");
    			attr_dev(div1, "class", "svelte-21b3a");
    			add_location(div1, file$b, 17, 0, 565);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src\\Componets\\Navigation\\Navigation.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-u2jykp");
    			add_location(a0, file$a, 13, 23, 301);
    			attr_dev(div0, "class", "links svelte-u2jykp");
    			add_location(div0, file$a, 13, 4, 282);
    			attr_dev(a1, "href", "None");
    			attr_dev(a1, "class", "svelte-u2jykp");
    			add_location(a1, file$a, 14, 23, 359);
    			attr_dev(div1, "class", "links svelte-u2jykp");
    			add_location(div1, file$a, 14, 4, 340);
    			attr_dev(a2, "href", "home");
    			attr_dev(a2, "class", "svelte-u2jykp");
    			add_location(a2, file$a, 15, 23, 414);
    			attr_dev(div2, "class", "links svelte-u2jykp");
    			add_location(div2, file$a, 15, 4, 395);
    			attr_dev(div3, "class", "Nav svelte-u2jykp");
    			set_style(div3, "margin-top", "1vmax");
    			add_location(div3, file$a, 12, 0, 233);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$9 = "src\\Componets\\Search-Bar\\SearchBar.svelte";
    ...
    const file$8 = "src\\Componets\\Suggest\\Suggest.svelte";
    ...
    const file$7 = "src\\Componets\\UpComming\\UpComming.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			img = element("img");
    			add_location(h1, file$7, 27, 26, 886);
    			add_location(p, file$7, 27, 35, 895);
    			attr_dev(div0, "class", "text svelte-1l2yunx");
    			add_location(div0, file$7, 27, 8, 868);
    			...
    			add_location(img, file$7, 28, 8, 918);
    			attr_dev(div1, "class", "suggest svelte-1l2yunx");
    			add_location(div1, file$7, 26, 4, 837);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_prev_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$7, 24, 8, 771);
    			attr_dev(div, "slot", "prev");
    			attr_dev(div, "class", "custom-arrow custom-arrow-prev");
    			add_location(div, file$7, 23, 4, 681);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_next_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$7, 31, 8, 1121);
    			attr_dev(div, "slot", "next");
    			attr_dev(div, "class", "custom-arrow custom-arrow-next");
    			add_location(div, file$7, 30, 4, 1031);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 17, 0, 479);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\Componets\\Footer\\Footer.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "Box svelte-g5f28b");
    			add_location(div, file$5, 20, 0, 782);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function url_type(url_check) {
    	if (window.location.href.includes(url_check)) {
    		return true;
    	}
    }
